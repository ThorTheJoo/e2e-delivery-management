...
const MOCK_TMF_ODA_DOMAINS: Omit<
  TMFOdaDomain,
  'id' | 'capabilities' | 'isSelected' | 'createdAt' | 'updatedAt'
>[] = [
  {
...
const MOCK_TMF_ODA_CAPABILITIES: Record<
  string,
  Omit<TMFOdaCapability, 'id' | 'domainId' | 'isSelected' | 'createdAt' | 'updatedAt'>[]
> = {
  'Market & Sales Domain': [
    {
      name: 'Sales Territory Management',
      description: 'Define and manage sales territories and coverage',
    },
    {
      name: 'Sales & Customer Development',
      description: 'Develop sales strategies and customer relationships',
    },
    { name: 'Lead Management', description: 'Track and manage sales leads through the pipeline' },
    {
      name: 'Marketing Campaign Workflow Design',
      description: 'Design and execute marketing campaigns',
    },
  ...
  'Product Domain': [
    {
      name: 'Ordering Rules Development',
      description: 'Define business rules for product ordering',
    },
    {
      name: 'Product Performance Reporting',
      description: 'Monitor and report on product performance metrics',
    },
    {
      name: 'Product Trouble Ticket Management',
      description: 'Handle product-related issues and support tickets',
    },
    {
      name: 'Product Specification & Offering Strategy Management',
      description: 'Manage product specifications and strategies',
    },
    {
      name: 'Offer and Product Configuration',
      description: 'Configure product offerings and bundles',
    },
    { name: 'Product Activation', description: 'Activate products and services for customers' },
    {
      name: 'Product Profitability Analysis',
      description: 'Analyze product profitability and financial performance',
    },
  ],
  'Customer Domain': [
    {
      name: 'Customer Interaction Management',
      description: 'Manage all customer touchpoints and interactions',
    },
    {
      name: 'Customer Order Management',
      description: 'Handle customer order processing and lifecycle',
    },
    {
    ...
    {
      name: 'Billing Account Administration',
      description: 'Manage customer billing accounts and preferences',
    },
    {
      name: 'Personalized Customer Interaction',
      description: 'Deliver personalized customer experiences',
    },
    {
      name: 'Customer Order Completion',
      description: 'Ensure successful completion of customer orders',
    },
    {
      name: 'Customer Experience Analysis',
      description: 'Analyze and improve customer experience metrics',
    },
  ],
  'Service Domain': [
    { name: 'Service Interaction', description: 'Manage service-related customer interactions' },
    {
      ...
      description: 'Track and manage service inventory and availability',
    },
    ...
    {
      name: 'Service Quality and Performance Analysis',
      description: 'Monitor service quality and performance metrics',
    },
  ...
  'Resource Domain': [
    {
      name: 'Resource Interaction Management',
      description: 'Manage resource-related interactions and requests',
    },
    {
      name: 'Resource Test Reporting',
      description: 'Generate reports on resource testing and validation',
    },
    {
      name: 'Resource Inventory Management',
      description: 'Track and manage resource inventory and availability',
    },
    {
      name: 'Resource Network Management',
      description: 'Manage network resources and connectivity',
    },
    {
      name: 'Resource Capacity Management',
      description: 'Monitor and manage resource capacity and utilization',
    },
    {
      name: 'Resource Planning and Building',
      description: 'Plan and build new resources and infrastructure',
    },
    {
      name: 'Resource Problem Management',
      description: 'Handle resource-related issues and problems',
    },
    {
      name: 'Resource Specification and Capability Development',
      description: 'Define resource specifications and capabilities',
    },
  ],
  'Business Partner Domain': [
    {
      name: 'Business Partner Order Management',
      description: 'Manage orders and transactions with business partners',
    },
    {
      name: 'Business Partner Product Regulatory Management',
      description: 'Handle regulatory compliance for partner products',
    },
    {
      name: 'Business Partner Onboarding',
      description: 'Onboard new business partners and vendors',
    },
    {
      name: 'Business Partner Agreement Management',
      description: 'Manage partner agreements and contracts',
    },
    {
      name: 'Purchasing Strategy Definition',
      description: 'Define purchasing strategies and policies',
    },
    {
      name: 'Purchasing Tender Management',
      description: 'Manage purchasing tenders and procurement processes',
    },
  ],
  'Enterprise Domain': [
    {
      name: 'Security Strategy Definition and Management',
      description: 'Define and manage enterprise security strategies',
    },
    {
      name: 'Human Resources Management',
      description: 'Manage human resources and workforce planning',
    },
    {
      name: 'Intellectual Property Management',
      description: 'Protect and manage intellectual property assets',
    },
    { name: 'Workforce Organization', description: 'Organize and structure workforce and teams' },
    {
      name: 'Auditing and Accounting',
      description: 'Handle financial auditing and accounting processes',
    },
    { name: 'Payroll Management', description: 'Manage employee payroll and compensation' },
    {
      name: 'Regulatory Rules Application and Tracking',
      description: 'Apply and track regulatory compliance rules',
    },
    {
      name: 'Corporate Real Estate (Buildings)',
      description: 'Manage corporate real estate and facilities',
    },
  ],
  'Shared Domain': [
    {
      name: 'Identification and Authentication',
      description: 'Provide user identification and authentication services',
    },
    {
      name: 'Digital Identity Management',
      description: 'Manage digital identities and access control',
    },
    { name: 'System Administration', description: 'Administer system configurations and settings' },
    {
      name: 'Business Intelligence',
      description: 'Provide business intelligence and analytics capabilities',
    },
    { name: 'Anomaly Detection', description: 'Detect and alert on system anomalies and issues' },
    {
      name: 'Data Repository Management',
      description: 'Manage data repositories and storage systems',
    },
    {
      name: 'Privacy Definition Management',
      description: 'Define and manage privacy policies and controls',
    },
    { name: 'Roles & Permission Definition', description: 'Define user roles and permissions' },
    {
      name: 'Project Repository Management',
      description: 'Manage project repositories and documentation',
    },
  ],
  'Integration Domain': [
    ...
    {
      name: 'API Implementation and Integration Management',
      description: 'Implement and manage APIs and integrations',
    },
    {
      name: 'External Business Access Management',
      description: 'Manage external business access and connectivity',
    },
    {
      name: 'Customer Service Access Management',
      description: 'Manage customer service access and support',
    },
    {
      name: 'Business Process Improvement',
      description: 'Improve and optimize business processes',
    },
...
export function TMFOdaManager({ onStateChange, initialState }: TMFOdaManagerProps) {
  const [state, setState] = useState<TMFOdaState>(
    initialState || {
      domains: [],
      selectedDomainIds: [],
  ...
  useEffect(() => {
    if (!initialState && state.domains.length === 0) {
      const mockDomains = MOCK_TMF_ODA_DOMAINS.map((domain) => ({
        ...
        capabilities:
          MOCK_TMF_ODA_CAPABILITIES[domain.name]?.map((capability) => ({
            ...capability,
  ...
  const handleRemoveDomain = (domainId: string) => {
    setState((prev) => ({
      ...
      selectedCapabilityIds: prev.selectedCapabilityIds.filter(
        (id) =>
          !prev.domains
            .find((domain) => domain.id === domainId)
            ?.capabilities.some((cap) => cap.id === id),
      ),
    }));
  };
  ...
  const handleToggleDomainSelection = (domainId: string) => {
    setState((prev) => {
      ...
      const newSelectedCapabilityIds = prev.selectedCapabilityIds.filter(
        (id) => !domain.capabilities.some((cap) => cap.id === id),
      );
  ...
  const getSelectedCounts = () => {
    const selectedDomains = state.domains.filter((domain) =>
      state.selectedDomainIds.includes(domain.id),
    );
    const selectedCapabilities = selectedDomains.flatMap((domain) =>
      domain.capabilities.filter((capability) =>
        state.selectedCapabilityIds.includes(capability.id),
      ),
    );
  ...
  const handleSpecSyncImport = (specSyncData: SpecSyncState) => {
    ...
    specSyncData.items.forEach((item) => {
      ...
      const matchingDomain = state.domains.find(
        (domain) =>
  ...
  const getDomainUseCaseCount = (domainName: string) => {
    if (!specSyncState) return 0;
    const domainItems = specSyncState.items.filter(
      (item) => (item.domain || '').trim().toLowerCase() === domainName.toLowerCase(),
    );
  ...
  const getSelectedCapabilityCount = (domainId: string) => {
    ...
    return domain.capabilities.filter((cap) => state.selectedCapabilityIds.includes(cap.id)).length;
  };

  const getCapabilityRequirementCount = (capabilityName: string) => {
    if (!specSyncState) return 0;
    return specSyncState.items.filter(
      (item) =>
        (item.capability || item.afLevel2 || '').trim().toLowerCase() ===
  ...
  const getCapabilityUseCaseCount = (capabilityName: string) => {
    if (!specSyncState) return 0;
    const capabilityItems = specSyncState.items.filter(
      (item) =>
        (item.capability || item.afLevel2 || '').trim().toLowerCase() ===
        capabilityName.toLowerCase(),
    );
        ...
        <CardContent>
          ...
          <div className="mt-4 border-t border-blue-200 pt-4">
            <div className="text-sm text-blue-800">
              ...
              <p>
                • {state.domains.reduce((sum, domain) => sum + domain.capabilities.length, 0)} total
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg border-2 border-blue-200 bg-blue-100">
                {isSpecSyncExpanded ? (
                  <ChevronDown className="h-7 w-7 text-blue-700" />
                ) : (
                  ...
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setNewDomainForm((prev) => ({ ...prev, name: e.target.value }))
                        }
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setNewDomainForm((prev) => ({ ...prev, description: e.target.value }))
                        }
                        className="w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <Button
                          ...
                          variant="ghost"
                          onClick={() =>
                            setEditingDomain(editingDomain === domain.id ? null : domain.id)
                          }
                        >
                        ...
                        <Button
                          ...
                          variant="ghost"
                          onClick={() =>
                            setShowAddCapabilityForm(
                              showAddCapabilityForm === domain.id ? null : domain.id,
                            )
                          }
                        >
                      ...
                      <div className="grid grid-cols-1 gap-4 rounded-md bg-gray-50 p-4 md:grid-cols-2">
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setNewCapabilityForm((prev) => ({ ...prev, name: e.target.value }))
                            }
                            className="w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                              ...
                              <div className="flex-1">
                                {editingCapability === capability.id ? (
                                  <input
                                    ...
                                    onChange={(e) =>
                                      handleEditCapability(capability.id, 'name', e.target.value)
                                    }
                                    className="w-full rounded border border-gray-300 px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    onBlur={() => setEditingCapability(null)}
                                    onKeyDown={(e) =>
                                      e.key === 'Enter' && setEditingCapability(null)
                                    }
                                    autoFocus
                                  />
                                ) : (
                                ...
                                {editingCapability === capability.id ? (
                                  <input
                                    ...
                                    className="mt-1 w-full rounded border border-gray-300 px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500"
                                    placeholder="Enter description"
                                    onBlur={() => setEditingCapability(null)}
                                    onKeyDown={(e) =>
                                      e.key === 'Enter' && setEditingCapability(null)
                              ...
                              <Button
                                ...
                                onClick={() =>
                                  setEditingCapability(
                                    editingCapability === capability.id ? null : capability.id,
                                  )
                                }
                              >
                                <Edit className="h-4 w-4" />
                ...
                <Card className="border-dashed border-gray-300">
                  <CardContent className="py-12 text-center">
                    <div className="text-gray-500">
                      <p className="mb-2 text-lg font-medium">No TMF ODA domains added yet</p>
                      <p className="text-sm">
                        Click "Add Domain" to get started with TMF ODA management
                      </p>
                    </div>
                  </CardContent>
                </Card>
