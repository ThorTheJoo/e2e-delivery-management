  ...
  if (searchInput) {
    searchInput.addEventListener('input', (e) => {
      ...
      capabilityCards.forEach((card) => {
        ...
        const matches =
          capabilityName.includes(searchTerm) || tags.some((tag) => tag.includes(searchTerm));
...
function updateCanvasStatus() {
  ...
  const selectedCapabilities = document.querySelectorAll(
    '.capability-card input[type="checkbox"]:checked',
  );
